...
public static class BookMessages
{
    ...
    public const string BookFoundSuccessfully = "Book found successfully"; 
    public const string BooksFoundSuccessfully = "Books found successfully";
    public const string Created = "Book created successfully";
